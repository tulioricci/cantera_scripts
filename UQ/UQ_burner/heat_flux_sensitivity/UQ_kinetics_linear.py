...
if mech == "uiuc_20sp":
    new_A_parameters = [2.644000e+13, 4.760000e+04, ( 2.477000e+27, 1.270000e+13 ), 1.870000e+14, 8.430000e+10, 7.600000e+09, 1.652000e+13, 7.485000e+10, 4.600000e+13, 3.000000e+10]
...
for ii, _ireact in enumerate(list_of_reactions):
    ...
    if type(new_A_parameters[ii]) is tuple:
        new_A_low = new_A_parameters[ii][0]
        ...
        new_A_high = new_A_parameters[ii][1]
